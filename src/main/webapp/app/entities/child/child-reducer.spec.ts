...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './child.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHILD_LIST actions', async () => {
    ...
    it('dispatches FETCH_CHILD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CHILD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CHILD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CHILD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CHILD actions', async () => {
      const expectedActions = [
        {
