...
export const getEntities = createAsyncThunk('child/fetch_entity_list', async ({ sort }: IQueryParams) => {
...
export const createEntity = createAsyncThunk(
  ...
  async (entity: IChild, thunkAPI) => {
    const result = await axios.post<IChild>(apiUrl, cleanEntity(entity));
