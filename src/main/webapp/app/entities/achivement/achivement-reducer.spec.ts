...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACHIVEMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACHIVEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACHIVEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACHIVEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACHIVEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACHIVEMENT actions', async () => {
      const expectedActions = [
        {
