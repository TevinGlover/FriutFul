...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './parents.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PARENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PARENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PARENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PARENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PARENTS actions', async () => {
      const expectedActions = [
        {
