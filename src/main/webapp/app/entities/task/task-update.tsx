  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="fruitFulApp.task.home.createOrEditLabel" data-cy="TaskCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Name" id="task-name" name="name" data-cy="name" type="text" />
              <ValidatedField label="Description" id="task-description" name="description" data-cy="description" type="text" />
              <ValidatedField label="Point Value" id="task-pointValue" name="pointValue" data-cy="pointValue" type="text" />
