...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POINTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_POINTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POINTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POINTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POINTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POINTS actions', async () => {
      const expectedActions = [
        {
