...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './balance.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BALANCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_BALANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BALANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BALANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BALANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BALANCE actions', async () => {
      const expectedActions = [
        {
