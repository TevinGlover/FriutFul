...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CREDITSCORE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CREDITSCORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CREDITSCORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CREDITSCORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CREDITSCORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CREDITSCORE actions', async () => {
      const expectedActions = [
        {
