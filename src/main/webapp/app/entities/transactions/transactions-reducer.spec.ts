...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSACTIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRANSACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRANSACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRANSACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRANSACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRANSACTIONS actions', async () => {
      const expectedActions = [
        {
