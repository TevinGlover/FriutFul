    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{transactionsEntity.date ? <TextFormat value={transactionsEntity.date} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>Account</dt>
          <dd>{transactionsEntity.account ? transactionsEntity.account.id : ''}</dd>
        </dl>
