            ...
            <tbody>
              {transactionsList.map((transactions, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{transactions.date ? <TextFormat type="date" value={transactions.date} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{transactions.account ? <Link to={`/balance/${transactions.account.id}`}>{transactions.account.id}</Link> : ''}</td>
